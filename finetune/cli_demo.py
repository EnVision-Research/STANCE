...
from models.pipeline import CogVideoXImageToVideoPipeline as MotionDreamerPipeline
from diffusers import CogVideoXImageToVideoPipeline as VideoDecoderPipeline
...
def generate_video(
    ...
    md_pipe = MotionDreamerPipeline.from_pretrained(model_path, torch_dtype=dtype)
    vd_pipe = VideoDecoderPipeline.from_pretrained(model_path, torch_dtype=dtype)
